        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * ,s.quantity AS squantity FROM sales_record s JOIN product p ON s.prod_id = p.prod_id";
                    if ($result = mysqli_query($conn, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                // echo "<td>";
                                // echo "<a href='readCust.php?id=" . $row['username'] .
                                //  " 'title='View Record'>View</a>";
                                // echo "<a href='updCust.php?id=" . $row['username'] . 
                                // " 'title='Update Record'>Update</a>";
                                // echo "<a href='delCust.php?id=" . $row['username'] . 
